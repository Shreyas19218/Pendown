      ...
      <div className="container text-center text-md-left">
        <div className="row text-center text-md-left">
          <div className="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
            ...
            <p><i className="fas fa-envelope mr-3"></i> shreyassnehal6@gmail.com</p>
        ...
        <hr className="mb-4" />
          <div className="row align-items-center">
            <div className="col-md-7 col-lg-8">
              <p> Copyright <i className="fa-sharp fa-regular fa-copyright"></i>2025 All rights reserved by:
              ...
              <div className="text-center text-md-right">
                <ul className="list-unstyled list-inline">
                  <li className="list-inline-item">
                    <Link to="https://www.linkedin.com/in/shreyas-snehal-3a70bb334?trk=contact-info" className="btn-floating btn-sm text-white fontsize23px"><i className="fab fa-linkedin-in"></i></Link> 
                  </li>
                  <li className="list-inline-item">
